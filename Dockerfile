...
Center for Biosustainability, Technical University of Denmark" \
    ...
    dk.dtu.biosustain.design-storage.alpine.build.base-tag="${BASE_TAG}" \
    dk.dtu.biosustain.design-storage.alpine.build.commit="${BUILD_COMMIT}" \
    dk.dtu.biosustain.design-storage.alpine.build.timestamp="${BUILD_TIMESTAMP}"
